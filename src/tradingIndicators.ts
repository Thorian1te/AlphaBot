  ...
  public analyzeTradingSignals(
    ...
    switch (lastAction) {
      case "sell":
        ...
        if (detectBottom.isTrendReversal && FiveMinuteRsi[FiveMinuteRsi.length - 1] <= 45 && detectRsiBottom.isTrendReversal) {
      ...
      case "buy": // last trade was a buy so look for a sell
        ...
        if (detectTop.isTrendReversal && detectRsiTop.isTrendReversal && FiveMinuteRsi[FiveMinuteRsi.length -1] >= 55) {

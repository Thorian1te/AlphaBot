...
export class TradingIndicators {
  ...
  public analyzeTradingSignals(
    ...
    const fiveMinuteDirection = this.determineDirection(oneMinuteChart[oneMinuteChart.length -1], fiveMinuteChart[fiveMinuteChart.length -1], oneMinuteChart.slice(-5), lastPrice)
